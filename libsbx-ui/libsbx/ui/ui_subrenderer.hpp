...
public:
  ...
  : graphics::subrenderer{stage},
    ...
    auto vertices = std::vector<vertex2d>{
      vertex2d{math::vector2f{0.0f, 0.0f}, math::vector2f{0.0f, 0.0f}},
      vertex2d{math::vector2f{1.0f, 0.0f}, math::vector2f{1.0f, 0.0f}},
      vertex2d{math::vector2f{1.0f, 1.0f}, math::vector2f{1.0f, 1.0f}},
      vertex2d{math::vector2f{0.0f, 1.0f}, math::vector2f{0.0f, 1.0f}}
    };
