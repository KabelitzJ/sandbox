...
TEST(libsbx_math_matrix4x4, copy_constructor) {
  ...
  EXPECT_EQ(copy[0][1], 2.0f);
  EXPECT_EQ(copy[0][2], 3.0f);
  EXPECT_EQ(copy[0][3], 4.0f);

  EXPECT_EQ(copy[1][0], 5.0f);
  EXPECT_EQ(copy[1][1], 6.0f);
  EXPECT_EQ(copy[1][2], 7.0f);
  EXPECT_EQ(copy[1][3], 8.0f);

  EXPECT_EQ(copy[2][0], 9.0f);
  EXPECT_EQ(copy[2][1], 10.0f);
  EXPECT_EQ(copy[2][2], 11.0f);
  EXPECT_EQ(copy[2][3], 12.0f);

  EXPECT_EQ(copy[3][0], 13.0f);
  EXPECT_EQ(copy[3][1], 14.0f);
  EXPECT_EQ(copy[3][2], 15.0f);
  EXPECT_EQ(copy[3][3], 16.0f);
}
...
TEST(libsbx_math_matrix4x4, move_constructor) {
  ...
  EXPECT_EQ(move[0][0], 1.0f);
  EXPECT_EQ(move[0][1], 2.0f);
  EXPECT_EQ(move[0][2], 3.0f);
  EXPECT_EQ(move[0][3], 4.0f);

  EXPECT_EQ(move[1][0], 5.0f);
  EXPECT_EQ(move[1][1], 6.0f);
  EXPECT_EQ(move[1][2], 7.0f);
  EXPECT_EQ(move[1][3], 8.0f);

  EXPECT_EQ(move[2][0], 9.0f);
  EXPECT_EQ(move[2][1], 10.0f);
  EXPECT_EQ(move[2][2], 11.0f);
  EXPECT_EQ(move[2][3], 12.0f);

  EXPECT_EQ(move[3][0], 13.0f);
  EXPECT_EQ(move[3][1], 14.0f);
  EXPECT_EQ(move[3][2], 15.0f);
  EXPECT_EQ(move[3][3], 16.0f);
}
...
TEST(libsbx_math_matrix4x4, scalar_constructor) {
  ...
  EXPECT_EQ(matrix[0][2], 1.0f);
  EXPECT_EQ(matrix[0][3], 1.0f);

  EXPECT_EQ(matrix[1][0], 1.0f);
  EXPECT_EQ(matrix[1][1], 1.0f);
  EXPECT_EQ(matrix[1][2], 1.0f);
  EXPECT_EQ(matrix[1][3], 1.0f);

  EXPECT_EQ(matrix[2][0], 1.0f);
  EXPECT_EQ(matrix[2][1], 1.0f);
  EXPECT_EQ(matrix[2][2], 1.0f);
  EXPECT_EQ(matrix[2][3], 1.0f);

  EXPECT_EQ(matrix[3][0], 1.0f);
  EXPECT_EQ(matrix[3][1], 1.0f);
  EXPECT_EQ(matrix[3][2], 1.0f);
  EXPECT_EQ(matrix[3][3], 1.0f);
}
