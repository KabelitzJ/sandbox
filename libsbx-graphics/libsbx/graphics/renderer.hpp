...
protected:
  ...
  requires (std::is_constructible_v<Type, const std::filesystem::path&, const render_graph::pass&, Args...>)
  auto add_subrenderer(const std::filesystem::path& path, const render_graph::pass& pass, Args&&... args) -> Type& {
