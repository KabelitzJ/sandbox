...
: _clear_color{sbx::math::color::black()} {
  ...
  // Render stage 1: Scene
  {
    auto attachments = std::vector<sbx::graphics::attachment>{
      ...
      sbx::graphics::attachment{6, "resolve", sbx::graphics::attachment::type::image, _clear_color, sbx::graphics::format::r8g8b8a8_unorm}
    };

    auto subpass_bindings = std::vector<sbx::graphics::subpass_binding>{
      sbx::graphics::subpass_binding{0, {0, 1, 2, 3, 4, 5}}, // Create deferred G-Buffer
      sbx::graphics::subpass_binding{1, {6}, {1, 2, 3, 4}},  // Deferred resolve
      sbx::graphics::subpass_binding{2, {0, 6}}              // Forward (transparency/foliage)
    };
