...
public:
  ...
  demo_application() {
    ...
    auto ambiebce_birds_sound_id = assets_module.load_asset<sbx::audio::sound_buffer>("res://audio/ambiebce_birds.wav");
    auto ambiebce_crickets_sound_id = assets_module.load_asset<sbx::audio::sound_buffer>("res://audio/ambiebce_crickets.wav");
    ...
    monkey.add_component<sbx::audio::sound>(ambiebce_crickets_sound_id, true, true, 0.5f, 1.0f);
