...
demo_renderer::demo_renderer() {
  {
    ...
    add_render_stage(std::move(attachments), std::move(subpass_bindings), sbx::graphics::viewport{sbx::math::vector2u{1024, 1024}});
  }

  {
    auto attachments = std::vector<sbx::graphics::attachment>{
      sbx::graphics::attachment{0, "depth", sbx::graphics::attachment::type::depth},
      sbx::graphics::attachment{1, "swapchain", sbx::graphics::attachment::type::swapchain, VK_FORMAT_R8G8B8A8_UNORM, sbx::math::color{0.52f, 0.80f, 0.98f, 1.0f}},
      sbx::graphics::attachment{2, "position", sbx::graphics::attachment::type::image, VK_FORMAT_R16G16B16A16_SFLOAT},
		  sbx::graphics::attachment{3, "diffuse", sbx::graphics::attachment::type::image, VK_FORMAT_R8G8B8A8_UNORM},
		  sbx::graphics::attachment{4, "normal", sbx::graphics::attachment::type::image, VK_FORMAT_R16G16B16A16_SFLOAT},
		  sbx::graphics::attachment{5, "material", sbx::graphics::attachment::type::image, VK_FORMAT_R8G8B8A8_UNORM},
		  sbx::graphics::attachment{6, "resolved", sbx::graphics::attachment::type::image, VK_FORMAT_R8G8B8A8_UNORM}
    };

    auto subpass_bindings = std::vector<sbx::graphics::subpass_binding>{
      sbx::graphics::subpass_binding{0, {0, 2, 3, 4, 5}},
      sbx::graphics::subpass_binding{1, {0, 6}},
...
auto demo_renderer::initialize() -> void {
  ...
  add_subrenderer<sbx::models::mesh_subrenderer>("res://shaders/mesh", sbx::graphics::pipeline::stage{1, 2});
