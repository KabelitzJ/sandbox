...
public:
  perspective_camera(const glm::vec3& position, const glm::vec3& direction, float field_of_view, float aspect_ratio, float near, float far, float pitch = 0.0f, float yaw = 0.0f);
