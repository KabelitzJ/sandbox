...
inline sparse_set_iterator<Container>::sparse_set_iterator(const container_type& container, const difference_type offset) noexcept
...
inline sparse_set_iterator<Container> sparse_set_iterator<Container>::operator++(int) noexcept {
  const auto copy = sparse_set_iterator{*this};
  return --copy;
}
...
inline sparse_set_iterator<Container> sparse_set_iterator<Container>::operator+(const difference_type offset) const noexcept {
  auto copy = sparse_set_iterator{*this};
  return copy -= offset;
}
...
template<container Container>
inline sparse_set_iterator<Container>::reference sparse_set_iterator<Container>::operator*() const {
  const auto data = _container->data();
  return data[index()];
}

template<container Container>
inline sparse_set_iterator<Container>::pointer sparse_set_iterator<Container>::operator->() const {
  const auto data = _container->data();
  return data + index();
}

template<container Container>
inline sparse_set_iterator<Container>::size_type sparse_set_iterator<Container>::index() const noexcept {
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::basic_sparse_set(basic_sparse_set&& other) noexcept
: _sparse{std::move(other._sparse)},
  _dense{std::move(other._dense)},
  _free_list{std::exchange(other._free_list, placeholder)} { }

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>& basic_sparse_set<Type, Allocator, PageSize>::operator=(basic_sparse_set&& other) noexcept {
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::size_type basic_sparse_set<Type, Allocator, PageSize>::size() const noexcept {
  return _dense.size();
}
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_pointer basic_sparse_set<Type, Allocator, PageSize>::data() const noexcept {
  return _dense.data();
}

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_iterator basic_sparse_set<Type, Allocator, PageSize>::begin() const noexcept {
  const auto position = static_cast<difference_type>(_dense.size());
  return const_iterator{_dense, position};
}

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_iterator basic_sparse_set<Type, Allocator, PageSize>::cbegin() const noexcept {
  return begin();
}

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_iterator basic_sparse_set<Type, Allocator, PageSize>::end() const noexcept {
  return const_iterator{_dense, difference_type{0}};
}

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_iterator basic_sparse_set<Type, Allocator, PageSize>::cend() const noexcept {
  return end();
}

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_iterator basic_sparse_set<Type, Allocator, PageSize>::find(const Type value) const noexcept {
  return contains(value) ? --(cend() - index(value)) : cend();
}

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline bool basic_sparse_set<Type, Allocator, PageSize>::contains(const value_type value) const noexcept {
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::size_type basic_sparse_set<Type, Allocator, PageSize>::index(const value_type value) const noexcept {
  SBX_ASSERT(contains(value), "Value is not in the set");
  return static_cast<size_type>(_sparse_reference(value));
}

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_reference basic_sparse_set<Type, Allocator, PageSize>::at(const size_type index) const {
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_reference basic_sparse_set<Type, Allocator, PageSize>::operator[](const size_type index) const noexcept {
  SBX_ASSERT(index < _dense.size(), "Index is out of range");
  return _dense[index];
}

template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
basic_sparse_set<Type, Allocator, PageSize>::const_iterator basic_sparse_set<Type, Allocator, PageSize>::insert(const value_type value) {
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline void basic_sparse_set<Type, Allocator, PageSize>::_swap_and_pop(const_iterator first, const_iterator last) {
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::const_iterator basic_sparse_set<Type, Allocator, PageSize>::_try_insert(const value_type value) {
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::pointer basic_sparse_set<Type, Allocator, PageSize>::_sparse_pointer(const value_type value) const {
  const auto position = static_cast<size_type>(value);
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::reference basic_sparse_set<Type, Allocator, PageSize>::_sparse_reference(const value_type value) const {
...
template<std::unsigned_integral Type, allocator<Type> Allocator, std::size_t PageSize>
inline basic_sparse_set<Type, Allocator, PageSize>::reference basic_sparse_set<Type, Allocator, PageSize>::_assure_at_least(const value_type value) {
  const auto position = static_cast<size_type>(value);
  const auto page = position / page_size;

  if (page >= _sparse.size()) {
    _sparse.resize(page + size_type{1});
  }
