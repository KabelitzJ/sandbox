...
struct entity_traits {
  ...
  inline static constexpr auto reserved = entity_type{entity_mask | (version_mask << entity_shift)};
...
template<entity Entity>
[[nodiscard]] constexpr bool operator==(const Entity lhs, const null_entity_t rhs) noexcept;

inline constexpr null_entity_t null_entity{};

struct placeholder_entity_t {
...
[[nodiscard]] constexpr bool operator==(const placeholder_entity_t lhs, const placeholder_entity_t rhs) noexcept;

template<entity Entity>
[[nodiscard]] constexpr bool operator==(const Entity lhs, const placeholder_entity_t rhs) noexcept;

inline constexpr placeholder_entity_t placeholder_entity{};
