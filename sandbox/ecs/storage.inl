...
inline basic_storage<Entity, Component, Allocator>::basic_storage()
: _page_allocator{},
  _dense{} { }

template<entity Entity, component Component, allocator<Component> Allocator>
inline basic_storage<Entity, Component, Allocator>::basic_storage(const allocator_type& allocator)
: _page_allocator{allocator},
  _dense{allocator} { }

template<entity Entity, component Component, allocator<Component> Allocator>
inline basic_storage<Entity, Component, Allocator>::basic_storage(basic_storage&& other) noexcept
...
template<entity Entity, component Component, allocator<Component> Allocator>
inline basic_storage<Entity, Component, Allocator>& basic_storage<Entity, Component, Allocator>::operator=(basic_storage&& other) noexcept {
...
template<entity Entity, component Component, allocator<Component> Allocator>
basic_storage<Entity, Component, Allocator>::reference basic_storage<Entity, Component, Allocator>::_element_at(const size_type index) const {
  return _dense[index / page_size][fast_mod(index, page_size)];
}

template<entity Entity, component Component, allocator<Component> Allocator>
basic_storage<Entity, Component, Allocator>::pointer basic_storage<Entity, Component, Allocator>::_assure_at_least(const size_type index) {
...
basic_storage<Entity, Component, Allocator>::reference basic_storage<Entity, Component, Allocator>::_try_emplace(const entity_type entity, Args&&... args) {
...
template<entity Entity, component Component, allocator<Component> Allocator>
void basic_storage<Entity, Component, Allocator>::_shrink_to_fit(const size_type size) {
