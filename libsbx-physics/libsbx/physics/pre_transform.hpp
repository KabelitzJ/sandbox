// #ifndef LIBSBX_PHYSICS_PRE_TRANSFORM_MODULE_HPP_
// #define LIBSBX_PHYSICS_PRE_TRANSFORM_MODULE_HPP_
...
// class pre_transform_module final : public core::module<pre_transform_module> {

//   friend class scene;

//   inline static const auto is_registered = register_module(stage::pre_fixed);
...
//   pre_transform_module() {
    
//   }

//   ~pre_transform_module() override = default;

//   auto update() -> void override {
//     SBX_SCOPED_TIMER("pre_transform_module");
...
// #endif // LIBSBX_PHYSICS_PRE_TRANSFORM_MODULE_HPP_
