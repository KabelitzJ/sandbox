...
namespace Sbx.Managed
{
  ...
  internal static class TypeInterface
  {
    ...
    internal readonly static UniqueIdList<Type> _cachedTypes = new();
    internal readonly static UniqueIdList<MethodInfo> _cachedMethods = new();
    ...
    {
      { typeof(sbyte), ManagedType.Int8 },
      { typeof(byte), ManagedType.UInt8 },
      { typeof(short), ManagedType.Int16 },
      { typeof(ushort), ManagedType.UInt16 },
      { typeof(int), ManagedType.Int32 },
      { typeof(uint), ManagedType.UInt32 },
      { typeof(long), ManagedType.Int64 },
      { typeof(ulong), ManagedType.UInt64 },
      { typeof(float), ManagedType.Float32 },
      { typeof(double), ManagedType.Float64 },
      { typeof(Bool32), ManagedType.Boolean },
      { typeof(bool), ManagedType.Boolean },
    ...
    internal static unsafe void GetAssemblyTypes(int InAssemblyId, int* OutTypes, int* OutTypeCount)
    {
      try
      {
        ...
        {
          OutTypes[i] = _cachedTypes.Add(assemblyTypes[i]);
        }
      }
      catch (Exception ex)
      {
    ...
    internal static unsafe void GetBaseType(int InType, int* OutBaseType)
    {
      try
      {
        if (!_cachedTypes.TryGetValue(InType, out var type) || OutBaseType == null)
          return;
        ...
        *OutBaseType = _cachedTypes.Add(type.BaseType);
      }
      catch (Exception e)
      {
        HandleException(e);
    ...
    internal static unsafe Bool32 IsTypeSubclassOf(int InType0, int InType1)
    {
      try
      {
        if (!_cachedTypes.TryGetValue(InType0, out var type0) || !_cachedTypes.TryGetValue(InType1, out var type1))
          return false;
    ...
    internal static unsafe Bool32 IsTypeSZArray(int InTypeID)
    {
      try
      {
        if (!_cachedTypes.TryGetValue(InTypeID, out var type))
          return false;
    ...
    internal static unsafe void GetElementType(int InTypeID, int* OutElementTypeID)
    {
      try
      {
        ...
        *OutElementTypeID = _cachedTypes.Add(elementType);
      }
      catch (Exception e)
      {
        HandleException(e);
    ...
    internal static unsafe void GetTypeMethods(int InType, int* InMethodArray, int* InMethodCount)
    {
      try
      {
        ...
        *InMethodCount = methods.Length;
        ...
        {
          InMethodArray[i] = _cachedMethods.Add(methods[i]);
        }
      }
      catch (Exception e)
      {
    ...
    internal static unsafe void GetTypeFields(int InType, int* InFieldArray, int* InFieldCount)
    {
      try
      {
        ...
        *InFieldCount = fields.Length;
        ...
        {
          InFieldArray[i] = _cachedFields.Add(fields[i]);
        }
      }
      catch (Exception e)
      {
    ...
    internal static unsafe void GetTypeProperties(int InType, int* InPropertyArray, int* InPropertyCount)
    {
      try
      {
        ...
        *InPropertyCount = properties.Length;
        ...
        {
          InPropertyArray[i] = _cachedProperties.Add(properties[i]);
        }
      }
      catch (Exception e)
      {
    ...
    internal static unsafe Bool32 HasTypeAttribute(int InType, int InAttributeType)
    {
      try
      {
        if (!_cachedTypes.TryGetValue(InType, out var type) || !_cachedTypes.TryGetValue(InAttributeType, out var attributeType))
          return false;
      ...
      try
      {
        ...
        *OutAttributesCount = attributes.Length;
        ...
        for (int i = 0; i < attributes.Length; i++)
        {
          ...
          OutAttributes[i] = _cachedAttributes.Add(attribute);
        }
      }
      catch (Exception ex)
      {
    ...
    internal static unsafe void GetMethodInfoReturnType(int InMethodInfo, int* OutReturnType)
    {
      try
      {
        if (!_cachedMethods.TryGetValue(InMethodInfo, out var methodInfo) || OutReturnType == null)
          return;

        *OutReturnType = _cachedTypes.Add(methodInfo.ReturnType);
      }
      catch (Exception ex)
      {
        HandleException(ex);
    ...
    internal static unsafe void GetMethodInfoParameterTypes(int InMethodInfo, int* OutParameterTypes, int* OutParameterCount)
    {
      try
      {
        ...
        *OutParameterCount = parameters.Length;
        ...
        {
          OutParameterTypes[i] = _cachedTypes.Add(parameters[i].ParameterType);
        }
      }
      catch (Exception e)
      {
    ...
    internal static unsafe void GetMethodInfoAttributes(int InMethodInfo, int* OutAttributes, int* OutAttributesCount)
    {
      try
      {
        ...
        *OutAttributesCount = attributes.Length;
        ...
        for (int i = 0; i < attributes.Length; i++)
        {
          OutAttributes[i] = _cachedAttributes.Add(attributes[i]);
        }
      }
      catch (Exception ex)
      {
    ...
    internal static unsafe void GetFieldInfoType(int InFieldInfo, int* OutFieldType)
    {
      try
      {
        ...
        *OutFieldType = _cachedTypes.Add(fieldInfo.FieldType);
      }
      catch (Exception ex)
      {
        HandleException(ex);
    ...
    internal static unsafe void GetPropertyInfoType(int InPropertyInfo, int* OutPropertyType)
    {
      try
      {
        ...
        *OutPropertyType = _cachedTypes.Add(propertyInfo.PropertyType);
      }
      catch (Exception ex)
      {
        HandleException(ex);
    ...
    internal static unsafe void GetAttributeType(int InAttribute, int* OutType)
    {
      try
      {
        ...
        *OutType = _cachedTypes.Add(attribute.GetType());
      }
      catch (Exception ex)
      {
        HandleException(ex);
