#ifndef LIBSBX_SCRIPTING_MANAGED_GARBAGE_COLLECTION_HPP_
#define LIBSBX_SCRIPTING_MANAGED_GARBAGE_COLLECTION_HPP_
...
#endif // LIBSBX_SCRIPTING_MANAGED_GARBAGE_COLLECTION_HPP_